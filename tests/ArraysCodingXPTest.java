...
public class ArraysCodingXPTest {

	@Test
	public void test_indexOf_AtIndex0() {
		int[] nums = {2,6,4,9,11,2};
		int expectedIndex = 0;
		int actualIndex = ArraysCodingXP.indexOf(nums, 2);
	...
	public void test_doubleSize() {
		...
		String[] strsUpdated = ArraysCodingXP.doubleSize(strs);
	...
	public void test_insert_middleOfFullArray() {
		...
		ArraysCodingXP.insert(nums, 45.1, 3);
