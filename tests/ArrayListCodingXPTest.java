...
public class ArrayListCodingXPTest {
	...
	public void test_indexOf_AtIndex0() {
		...
		nums.add(2);
		int expectedIndex = 0;
		int actualIndex = ArrayListCodingXP.indexOf(nums, 2);
	...
	public void test_insert_middleOfFullArray() {
		...
		nums.add(7.5);
		nums.add(4.3);
		ArrayListCodingXP.insert(nums, 45.1, 3);
	...
	public void test_lastInAlphabet_emptyList() {
		...
		String expected = "";
		String actual = ArrayListCodingXP.lastInAlphabet(strs);
